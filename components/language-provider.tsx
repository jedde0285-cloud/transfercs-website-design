...
const dictionaries: Record<Lang, Dict> = {
  ru: {
    nav: { calc: "Оценка", teams: "Команды", players: "Игроки", about: "О проекте" },
    hero: {
      badge: "Аналитика киберспорта · CS",
      titleTop: "Узнай реальную",
      titleAccent: "цену игрока",
      desc: "TransferCS рассчитывает трансферную стоимость киберспортсменов на основе статистики, формы и рыночных трендов. Оцени любого игрока за секунды.",
  ...
  en: {
    nav: { calc: "Valuation", teams: "Teams", players: "Players", about: "About" },
    hero: {
      badge: "Esports analytics · CS",
      titleTop: "Discover the real",
      titleAccent: "player price",
      desc: "TransferCS estimates the transfer value of esports players based on statistics, form and market trends. Value any player in seconds.",
